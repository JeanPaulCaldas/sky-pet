...
import 'application/auth/sign_up_form/cubit/sign_up_form_cubit.dart' as _i17;
...
import 'domain/usecases/auth/credential_sign_up.dart' as _i13;
import 'domain/usecases/auth/google_sign_in.dart' as _i15;
import 'domain/usecases/auth/sign_out.dart' as _i16;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i13.CredentialSignUp>(
      () => _i13.CredentialSignUp(repository: get<_i10.AuthRepository>()));
  gh.lazySingleton<_i14.FirebaseAuthFacade>(() => _i14.FirebaseAuthFacade(
      firebaseAuth: get<_i3.FirebaseAuth>(),
      googleSignIn: get<_i4.GoogleSignIn>()));
  gh.lazySingleton<_i15.GoogleSignIn>(
      () => _i15.GoogleSignIn(repository: get<_i10.AuthRepository>()));
  gh.lazySingleton<_i16.SignOut>(
      () => _i16.SignOut(repository: get<_i10.AuthRepository>()));
  gh.factory<_i17.SignUpFormCubit>(() => _i17.SignUpFormCubit(
      get<_i13.CredentialSignUp>(), get<_i15.GoogleSignIn>()));
  gh.factory<_i18.AuthBloc>(() => _i18.AuthBloc(
      authUserState: get<_i12.AuthUserState>(), signOut: get<_i16.SignOut>()));
  return get;
}
